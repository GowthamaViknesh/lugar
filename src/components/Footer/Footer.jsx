      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pt-8 border-t border-gray-800">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-black hover:text-white transition-colors">Career</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Events</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Services</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Industries</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Case Study</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-xl font-bold mb-4">Mobile App</h3>
            <ul className="space-y-2">
              <li><a href="#" className="text-black hover:text-white transition-colors">Android Apps</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">iPhone Apps</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Hybrid Apps</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Flutter</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">React Native</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Kotlin</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-xl font-bold mb-4">Web</h3>
            <ul className="space-y-2">
              <li><a href="#" className="text-black hover:text-white transition-colors">PHP</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Java</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Python</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">WordPress</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Drupal</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Laravel</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-xl font-bold mb-4">Ecommerce</h3>
            <ul className="space-y-2">
              <li><a href="#" className="text-black hover:text-white transition-colors">Magento</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Shopify</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Ubercart</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">Prestashop</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">CS Cart</a></li>
              <li><a href="#" className="text-black hover:text-white transition-colors">VirtueMart</a></li>
            </ul>
          </div>
        </div>

        {/* Country Offices Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12 border-t border-gray-800 pt-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mt-8 border-t border-gray-800 pt-8">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-black hover:text-gray-600 transition-colors">Contact Us</a></li>
              <li><a href="#" className="text-black hover:text-gray-600 transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-black hover:text-gray-600 transition-colors">Cyber Security Policy</a></li>
              <li><a href="#" className="text-black hover:text-gray-600 transition-colors">Sitemap</a></li>
              <li><a href="#" className="text-black hover:text-gray-600 transition-colors">Global</a></li>
            </ul>
          </div>
        ...
        {/* Copyright Section */}
        <div className="pt-9 border-t border-t-black font-bold">
